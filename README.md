Create a small web application using the latest version of the Angular framework to partly consume the FAKE Rest API offered by https://jsonplaceholder.typicode.com/
